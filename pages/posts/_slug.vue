...
<v-row class="justify-center pt-8">
  ...
  <h1 style="font-family: 'Chakra Petch' !important;" class="text-h2 mb-8">{{post.title}}</h1>
  <v-divider class="my-6" width="60%" style="margin-left: -30%; left: 50%; position: relative;" />
